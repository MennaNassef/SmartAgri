...
console.log("5");
 ...
 function analyze() {
      ...
      setTimeout(() => { // تأخير قصير للتأثير
        ...
        const problemTips = {
          "حشرات": "🐛 توجد حشرات: استخدم رش طبيعي مثل مستخلص الثوم أو النيم، وازالة النباتات المصابة.",
          "أمراض": "🦠 أمراض النبات: ازالة الأجزاء المصابة وتهوية الأرض جيدًا، وتجنب الإفراط في الري.",
          "نقص تغذية": "🥗 نقص تغذية: استخدم سماد عضوي أو متوازن، وأضف سماد كلسيوم إذا كان الطماطم أو الخيار.",
          "جفاف": "💧 جفاف: غطِ التربة بالقش لتقليل التبخر وزد الري حسب الحاجة.",
          "تربة فقيرة": "🌾 تربة فقيرة: أضف سماد عضوي، قم بتدوير المحاصيل، واحرص على إضافة كومبوست."
        };
        tips += `<div class="tip">${problemTips[problem] || "✅ لا توجد مشاكل واضحة. حافظ على الري والتسميد المنتظم."}</div>`;

        // نصائح حسب الموارد
        const resourceTips = {
          "سماد عضوي": "🌿 استخدم السماد العضوي لتحسين خصوبة التربة وزيادة الإنتاج.",
          "مياه إضافية": "💧 استفد من المياه الإضافية أثناء فترات الجفاف لتجنب خسارة المحصول.",
          "غطاء التربة بالقش": "🟤 غطاء التربة بالقش يساعد على حفظ الرطوبة والتقليل من الأعشاب الضارة."
        };
        if(resourceTips[resource]) tips += `<div class="tip">${resourceTips[resource]}</div>`;

        // نصائح حسب مرحلة النمو
        const stageTips = {
          "زراعة": "🌱 مرحلة الزراعة: تأكد من توزيع البذور بشكل متساوي وتحضير التربة جيدًا.",
